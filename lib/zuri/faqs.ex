defmodule Zuri.Faqs do
  ...
  def answer_faq(%Faq{} = faq, attrs \\ %{}) do
    faq
    |> Faq.changeset_answer(attrs)
  end

  def update_faq_answer(%Faq{} = faq, attrs) do
    faq
    |> Faq.changeset_answer(attrs)
    |> Repo.update()
  end
  ...
  def update_faq_vote_count(%Faq{} = faq, attrs) do
    faq
    |> Faq.changeset_vote_count(attrs)
    |> Repo.update()
  end
